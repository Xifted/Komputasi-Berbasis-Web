...
<body>
    ...
    <section class="container my-3">
        ...
        <h1 class="border-bottom border-2 mt-3" style="width: max-content;">Detail Biodata</h1>
        <form class="mt-4" method="post">
            <div class="mb-3">
                <label for="name" class="form-label">Nama</label>
                <input type="text" class="form-control" id="name" name="fName" value="<?= $row['name'] ?>" disabled>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="membaca" id="hobbyReading" name="hobby[]" <?= in_array('membaca', explode(',', $row['hobbies'])) ? 'checked' : '' ?> disabled>
                    <label class="form-check-label" for="hobbyReading">Membaca</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="menyanyi" id="hobbySinging" name="hobby[]" <?= in_array('menyanyi', explode(',', $row['hobbies'])) ? 'checked' : '' ?> disabled>
                    <label class="form-check-label" for="hobbySinging">Menyanyi</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="lari" id="hobbyRunning" name="hobby[]" <?= in_array('lari', explode(',', $row['hobbies'])) ? 'checked' : '' ?> disabled>
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="gender" id="genderMale" value="male" <?= $row['gender'] == 'male' ? 'checked' : '' ?> disabled>
                    <label class="form-check-label" for="genderMale">Laki - Laki</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="gender" id="genderFemale" value="female" <?= $row['gender'] == 'female' ? 'checked' : '' ?> disabled>
                    <label class="form-check-label" for="genderFemale">Perempuan</label>
                </div>
            </div>
            <div class="mb-3">
                <label for="birthDate" class="form-label">Tanggal Lahir</label>
                <input type="date" class="form-control" id="birthDate" name="fBirth" value="<?= $row['birthDate'] ?>" disabled>
            </div>
        </form>
    </section>
